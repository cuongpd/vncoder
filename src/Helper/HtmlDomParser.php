...
class HtmlDomParser
{
    public static function dom($url = '')
    {
        ...
        return self::str_get_html($content);
    }

    public static function domContent($content = '')
    {
        return self::str_get_html($content);
    }
    
    protected static function str_get_html($str, $lowercase = true, $forceTagsClosed = true, $target_charset = DEFAULT_TARGET_CHARSET, $stripRN = true, $defaultBRText = DEFAULT_BR_TEXT, $defaultSpanText = DEFAULT_SPAN_TEXT)
    {
...
class simple_html_dom
{
    ...
    function __toString()
    {
        return trim($this->root->innertext());
    }
